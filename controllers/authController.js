...
const db = require('../app/db'); // Asegúrate de que esta ruta sea correcta
const config = require('../app/config'); // Cargar variables de entorno
...
const login = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({ id: user.id, rol: user.rol }, config.jwt.secretkey, { expiresIn: config.jwt.tokenExpiresIn });
